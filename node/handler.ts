...
export abstract class DeleteExpiredEmailVerificationTokensHandlerInterface implements RemoteCallHandlerInterface {
  public descriptor = DELETE_EXPIRED_EMAIL_VERIFICATION_TOKENS;
  public abstract handle(
    loggingPrefix: string,
...
export abstract class DeleteExpiredPasswordResetTokensHandlerInterface implements RemoteCallHandlerInterface {
  public descriptor = DELETE_EXPIRED_PASSWORD_RESET_TOKENS;
  public abstract handle(
    loggingPrefix: string,
